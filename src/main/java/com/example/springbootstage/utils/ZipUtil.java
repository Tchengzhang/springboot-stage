...
public class ZipUtil {
     ...
     */
    public static boolean toZip(String srcFilePath, String tarFilePath, boolean KeepDirStructure,String tarFileCode,String systemType) throws Exception {
        ...
        try {
            ...
            zos.setEncoding(tarFileCode);
            compress(sourceFile, zos, sourceFile.getName(), KeepDirStructure,systemType);
     ...
     * @throws Exception
     */
    private static void compress(File sourceFile, ZipOutputStream zos, String name, boolean KeepDirStructure,String systemType)
            throws Exception {
            ...
            if (listFiles == null || listFiles.length == 0) {
                ...
                for (File file : listFiles) {
                    ...
                    if (KeepDirStructure) {
                        ...
                        compress(file, zos, name + "/" + file.getName(), KeepDirStructure,systemType);
                    } else {
                        compress(file, zos, file.getName(), KeepDirStructure,systemType);
                    }
                }
            }
        }
